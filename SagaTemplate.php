...
class SagaTemplate extends BaseTemplate {
	...
	public function execute() {
		...
		if ( $this->config->get( 'SagaUseIconWatch' ) ) {
...
class="sagaTabs<?php
				...
				case 'VARIANTS':
					?>
					<div id="p-variants" role="navigation" class="sagaMenu<?php
				...
				case 'VIEWS':
					?>
					<div id="p-views" role="navigation" class="sagaTabs<?php
				...
				case 'ACTIONS':
					?>
					<div id="p-cactions" role="navigation" class="sagaMenu<?php
					if ( count( $this->data['action_urls'] ) == 0 ) {
						echo ' emptyPortlet';
					}
					?>" aria-labelledby="p-cactions-label">
						<h3 id="p-cactions-label"><span><?php
							$this->msg( 'saga-more-actions' )
						?></span><a href="#"></a></h3>
				...
				case 'SEARCH':
					...
					<div id="p-search" role="search">
						...
						<form action="<?php $this->text( 'wgScript' ) ?>" id="searchform">
							<?php
							if ( $this->config->get( 'SagaUseSimpleSearch' ) ) {
							?>
							<div id="simpleSearch">
								<?php
							} else {
